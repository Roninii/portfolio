        ...
        <div class="container">
            <header class="header">
                <h1 class="header__name">
                    <span class="highlight--primary">Ron</span>nie Villar<span class="highlight--primary">ini</span>
                </h1>
                <h2 class="header__intro">
                    Hi, I'm Ronnie! I'm a full-stack developer living in a
                    <span
                        class="highlight--primary"
                    >JavaScript</span> paradise. 🌴
                </h2>
            </header>

            <section class="about">
                <p class="about__info">
                    I love bringing ideas to life and experimenting with new technology. I am
                    thriving in the JavaScript ecosystem, but I also love branching out into design
                    and learning new things. If I'm not coding, I'm probably spending time with my
                    family or Gaming!
                </p>
            </section>
            ...
            <section class="contact">
                ...
                <div class="contact__links">
                    ...
                    <a
                        href="mailto:villarini91@gmail.com"
                        target="_blank"
                        class="contact__link"
                        title="email"
                        rel="noreferrer"
            ...
            <section class="projects">
                ...
                <div class="projects__project">
                    <a
                        href="https://face-recognition-brain-4293.herokuapp.com/"
                        target="_blank"
                        class="project__link"
                        rel="noreferrer"
                        title="face-recognition brain"
                    >&rarr; Face-Recognition Brain</a>
                ...
                <div class="projects__project">
                    <a
                        href="https://esportacus.netlify.com/"
                        target="_blank"
                        class="project__link"
                        title="eSportacus"
                        rel="noreferrer"
